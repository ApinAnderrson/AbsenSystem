...
export default function create({ users, companies }) {
    ...
    function submit(e) {
        ...
        post(route('task.store')); // Explicitly send data
    }
        ...
        >
            ...
            <div className="-my-8">
                <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
                    <div className="overflow-hidden max-w-7xl w-full flex justify-center shadow-sm sm:rounded-lg p-14">
                        <div className="p-6 text-gray-900 max-w-xl w-full shadow-lg">
