                                                ...
                                                {filteredPJ.map((task, index)=>(
                                                    ...
                                                    <Fragment key={task.uuid} >
                                                        <tr id={task.uuid} className={`text-gray-950 text-lg text-left`}>
                                                            ...
                                                            <td>{ task.deadline }</td>
                                                            <td>
                                                                <button className='bg-red-800 px-5 py-2 rounded-md text-md text-bold text-white' onClick={(e)=>toggleDescription("submit", index, task.uuid)}>Result</button>
                                                            </td>
                                                            <td className=''>
                                                                <button>
                                                        ...
                                                        <tr className={`${showDescriptionSubmit.index === index ? '' : 'hidden'}`}>
                                                            <td colSpan={11} className={``}>
                                                                ...
                                                                {/* {console.log(task.result?.link)} */}

                                                                {/* Submit section */}
                                                                <div id="submitSection" className={`${showDescriptionSubmit.type === "submit" ? "block" : "hidden"}`}>
                                                                    <form onSubmit={submit}>
                                                                        <div className='text-2xl font-extrabold mb-1'>Yey! Your Task is Approved 😎🥰</div>
                                                                        <div className='w-full text-xl mt-3 rounded-lg' disable  onChange={(e)=> setData("link", e.target.value)}>{task.result?.link}</div>
                                                                    </form>
                                                                </div>
                                                            </td>
                                                        </tr>
