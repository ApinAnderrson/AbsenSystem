                                    ...
                                    <Fragment key = {user.password}>
                                        <tr>
                                            ...
                                            <td className=''>
                                                ...
                                                <div className= {`${showDeleteEdit === index ? '' : 'hidden'} bg-gray-950 ml-3 rounded-md absolute w-40 h-20 p-2 flex items-left flex-col justify-center`}>
                                                    <button id="delete" 
                                                        onClick={() => {
                                                            if (confirm("Are you sure?")) {
                                                                router.delete(route('user.destroy', { user: user.password }), {
                                                    ...
                                                    <Link id="edit" className='text-left ml-2 text-sm p-2 w-fit hover:text-green-600'>Edit</Link>
                                                </div >
                                            </td>
                                        </tr>
                                    </Fragment>
